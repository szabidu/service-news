...
public class Scheduler {
    ...
    private void createWedFri(LocalDate date, List<NewsBlock> result) {
        result.add(new NewsBlock("reggel", date.atTime(5, 0), 12 * 60));

        addShort(date, result, "3perces-6-7", 5, 54, 9, "2*3 perc + 3 a 12-ből");
        ...
        addShort(date, result, "3perces-21-22-havolt", 21, 57, 6);
